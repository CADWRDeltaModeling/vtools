...
class TestFilter(unittest.TestCase):
    ...
    def test_boxcar_nan(self):
        ...
        self.assertTrue(numpy.alltrue(numpy.isnan(nt.data[190:213])))
    ...
    def test_godin_2d(self):
        ...
        d1=nt3.data[:,0]
        d2=nt3.data[:,1]
        self.assertTrue(numpy.alltrue(numpy.isnan(d1[0:144])))
        assert_array_almost_equal(d1[144:192],[1]*48,12)
        self.assertTrue(numpy.alltrue(numpy.isnan(d1[192:481])))
        assert_array_almost_equal(d1[481:656],[1]*175,12)
        self.assertTrue(numpy.alltrue(numpy.greater(d1[656:944],1)))
        self.assertAlmostEqual(d1[868],1.916618441)
        assert_array_almost_equal(d1[944:1056],[2]*112,12)
        self.assertTrue(numpy.alltrue(numpy.greater(d1[1056:1344],1)))
        self.assertAlmostEqual(d1[1284],1.041451845)
        assert_array_almost_equal(d1[1344:1456],[1]*112,12)
        self.assertTrue(numpy.alltrue(numpy.isnan(d1[1456:1600])))

        self.assertTrue(numpy.alltrue(numpy.isnan(d2[0:144])))
        assert_array_almost_equal(d2[144:192],[1]*48,12)
        self.assertTrue(numpy.alltrue(numpy.isnan(d2[192:481])))
        assert_array_almost_equal(d2[481:656],[1]*175,12)
        self.assertTrue(numpy.alltrue(numpy.greater(d2[656:944],1)))
        self.assertAlmostEqual(d2[868],1.916618441)
        assert_array_almost_equal(d2[944:1056],[2]*112,12)
        self.assertTrue(numpy.alltrue(numpy.greater(d2[1056:1344],1)))
        self.assertAlmostEqual(d2[1284],1.041451845)
        assert_array_almost_equal(d2[1344:1456],[1]*112,12)
        self.assertTrue(numpy.alltrue(numpy.isnan(d2[1456:1600])))
