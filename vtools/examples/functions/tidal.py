...
temp=cosine_lanczos(ts,cutoff_period=hours(30),m=30)
ts_cosine=temp.window(window_start,window_end)
temp=butterworth(ts,cutoff_period=hours(60),order=4)
ts_butt=temp.window(window_start,window_end)
boxcar_aver_interval = hours(12)
temp=boxcar(ts,boxcar_aver_interval,boxcar_aver_interval)
