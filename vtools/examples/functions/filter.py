...
ts_cos=cosine_lanczos(ts_1day,cutoff_period=hours(1),m=10)
fig=plt.figure()
ax0 = fig.add_subplot(111)
ax0.set_ylabel("surface (feet)")
lwidth=0.8
p0=ax0.plot(ts_1day.times,ts_1day.data,color='green',linewidth=lwidth,label="Surface")
p1=ax0.plot(ts_butt.times,ts_butt.data,color='red',linewidth=lwidth,label="Butterworth")
p2=ax0.plot(ts_box.times,ts_box.data,color='black',linewidth=lwidth,label="Boxcar")
p3=ax0.plot(ts_cos.times,ts_cos.data,color='brown',linewidth=lwidth,label="Cosine")
